...
`;
    const light = `${c.canonicalAppOrigin}/users/${input.journal.username}/?` +
...
<div id='lj_controlstrip_search'>${search}
  Reload page in style:&nbsp;&nbsp;<a href='${light}'>light</a></div>

</div>
`;
}
export function head(input: RenderInput, page: S2Object): string {
...
export function hostData(input: RenderInput, page: S2Object, monday: boolean): S2Object {
    ...
    return {
        owner_user: input.journal.username, owner_userid: input.journal.userid, siteroot: c.siteRoot,
