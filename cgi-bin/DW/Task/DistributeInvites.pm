...
#
# Worker for invite code distribution.
#
# Authors:
...
sub work {
    ...
    unless ( defined $req_uid and defined $uckey and defined $ninv and defined $reason ) {
    ...
    unless ($req_user) {
        $log->warn("Unable to load requesting user");
