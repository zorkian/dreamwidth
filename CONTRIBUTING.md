...
* Read the [Dev Getting Started](https://wiki.dreamwidth.net/wiki/index.php/Dev_Getting_Started) wiki guide.  Bear in mind that any mentions of Bugzilla are out-of-date and should be considered docs bugs.  Note, though, that docs bugs do not belong on Github Issues, and should probably be raised in the dw-docs community.
* Check the [Programming Guidelines](https://wiki.dreamwidth.net/wiki/index.php/Programming_Guidelines)
* Send in a [Contributor Licensing Agreement](https://wiki.dreamwidth.net/wiki/index.php/Contributor_Licensing_Agreement)
* Start hacking!
